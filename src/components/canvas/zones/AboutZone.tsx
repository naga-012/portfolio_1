    ...
    <group position={[-16, 0, -1]}>
      ...
      <Float speed={1.5} rotationIntensity={0.1} floatIntensity={0.3}>
        <Html position={[0, 0, 0.5]} center transform distanceFactor={7.5} className="w-[720px] pointer-events-auto">
          <div className="p-6 rounded-3xl bg-slate-950/85 backdrop-blur-xl border border-cyan-500/30 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-mono text-slate-400">Hyderabad, India</span>
            </div>

            <h2 className="text-2xl font-bold text-white mb-2">About Nagarjun Myakala</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
                ...
                <div className="text-white text-xs font-medium">{portfolioData.education.degree}</div>
                <div className="text-slate-400 text-[11px] mt-0.5">{portfolioData.education.institution}</div>
                <div className="flex justify-between text-[11px] text-cyan-300 font-mono mt-2">
              ...
              <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
                ...
                <div className="text-white text-xs font-medium">{portfolioData.experience[0].role}</div>
                <div className="text-slate-400 text-[11px] mt-0.5">{portfolioData.experience[0].company}</div>
                <div className="flex justify-between text-[11px] text-purple-300 font-mono mt-2">
                  <span>{portfolioData.experience[0].period}</span>
                  <span>{portfolioData.experience[0].status}</span>
                </div>
              </div>
            </div>
